...
short int* create3Dmodel(int Nbins, float binsize, float d) {
...
float read_para(std::string dic) {
    float a[4];
...
int main()
{
    ...
    short int* T = create3Dmodel(Nbins,length_voxel,d);
    short int* T_lr = create3Dmodel_lr(int(Nbins / mag), mag,length_voxel,d);
